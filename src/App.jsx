...
export default () => {
  ...
  // const Brand = () => (
  //   <div className="bg-divBg flex items-center justify-between py-5 md:block">
  ...
  //       <button
  //         className="menu-btn text-gray-100 hover:text-gray-800"
  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        {/* <header>
          <div
            className={`bg-divBgmd:hidden ${state ? "mx-2 pb-5" : "hidden"}`}
          >
            <Brand />
          </div>
          <nav
        ...
        <Navbar />
        <section>
          <div className="bg-divBg rounded-lg max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-100 overflow-hidden md:px-8 md:flex">
